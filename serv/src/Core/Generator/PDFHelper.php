...
class PDFHelper {
    ...
    public static function pdf2text($filename, $search) {
        $pageNumber = 1;
        ...
        for ($i = 0; $i < count($objects); $i++) {
            ...
            if (preg_match("#stream(.*)endstream#ismU", $currentObject, $stream)) {
                ...
                //$textTransformed = self::getTextUsingTransformations($texts, $transformations);
                ...
                foreach ($texts as $key => $value) {
                    ...
                    if(array_key_exists($key, $textContainers))
                    ...
                    $textTransformed = self::getTextUsingTransformations($prearray, $transformations);
                    //print $textTransformed."<br><br><br>";
                    ...
                    if($pos !== false){
                        ...
                        if(!empty($data)){
                            ...
                            $returnArray['x'] = $dataArray[count($dataArray)+1];
                            $returnArray['y'] = $dataArray[6];
